...
| Modèles                                          | Description                                      | Statut | Exemple |
|  :---                                           |     :---                       |   :---:   |   :---:   |
| YOLOV10                                         |  detection de la liste COCO [voir la liste]([https://huggingface.co/onnx-community/yolov10m/blob/main/config.json](https://github.com/amikelive/coco-labels))                                              | ✅      |  [wiki](https://github.com/veka-server/onnx-php/wiki/yolov10)   |
| YOLOV5 Face                                     | ...                                              | ☐      |     |
